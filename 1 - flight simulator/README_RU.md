...
**На телефоне/планшете:** наклоняй устройство влево/вправо и вперёд/назад вместо стрелок, тапни и держи экран вместо Ctrl. На iOS при нажатии «Начать полёт» появится разовый запрос разрешения на датчики движения.
